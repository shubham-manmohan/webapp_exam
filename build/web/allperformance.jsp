<%-- 
    Document   : allperformance
    Created on : 8 Jun, 2021, 11:26:59 PM
...
<html>
    <head>
        ...
        <title>All Student Performance Page</title>
    ...
    <body>
        ...
        <br><br><br><hr><a type="button" class="btn-primary btn-block text-center badge" href="facultyoptions.jsp" >Back</a>
        <script>
                ...
                $.ajax({
                    ...
                    success: function(resp) {
                        ...
                        if(resp.trim()==="norecordfound")
                        {
                            ...
                            swal("No Record Found","No Student given exam yet..........","info");
                            setTimeout(function(){window.location="facultyoptions.jsp";},3000);
                            return;
                        }
