...
public class RemoveUserControllerServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       PrintWriter out = response.getWriter();
        ...
        boolean searchResult=search.removeUser((String)request.getParameter("removeuserid"));
        if(!searchResult)
        {
        ...
        if(request.getParameter("removeuserid").equalsIgnoreCase(user.getUserId()))
        {
          sess.invalidate();  
           out.println("youremoved");
        }
        }
            out.println("success");
        }
